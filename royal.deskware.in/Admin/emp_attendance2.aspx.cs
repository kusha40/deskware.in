...
public partial class Admin_emp_attendance2 : System.Web.UI.Page
{
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        for (j = 0; j < GridView2.Rows.Count; j++)
        {
            ...
            if (RadioButtonList1.SelectedValue == "P")
            {
                ...
                perday = Convert.ToDouble(double.Parse(TextBox1.Text));
            }
            //else
            //{
            //    perday = 0;
            ...
            if (cb.Checked == true)
            {
                ...
                if (count > 0)
                {
                    ClientScript.RegisterStartupScript(this.GetType(), "AlertBox", "alert('Submitted Sucessfully');window.location='emp_attendance2.aspx';", true);
                }

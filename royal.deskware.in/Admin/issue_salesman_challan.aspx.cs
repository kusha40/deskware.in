    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        for (j = 0; j < GridView2.Rows.Count; j++)
        {
            ...
            if (lbltype.Text == "D")
            {
                ...
                //Salesman debit ledger
                SqlCommand cmd311 = con.CreateCommand();
                cmd311.CommandText = " insert into tbl_dump_debit_master values ('" + lblname.Text + "','" + lblremarks.Text.Trim() + "','" + DateTime.ParseExact(txtdate.Text, "MM/dd/yyyy", CultureInfo.InvariantCulture).ToString("MM/dd/yyyy", CultureInfo.InvariantCulture) + "','','SD','" + lblamount.Text.Trim() + "')";

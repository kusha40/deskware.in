...
public partial class new_sample_challan : System.Web.UI.Page
{
    ...
    protected void btnsubmit_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            for (j = 0; j < GridView1.Rows.Count; j++)
            {
                ...
                ////saleman calulation//
                //adap = new SqlDataAdapter("select com_price from tbl_salesman_commission_pricing where salesman_id='" + Label43.Text + "' and size='" + size.Text + "' and c_name='" + c_name.Text + "' and dealer_id='" + ddlvendor.SelectedValue + "'", con);
                //ds = new DataSet();
                //adap.Fill(ds);
                //if (ds.Tables[0].Rows.Count != 0)
                //{
                //    DataRow dr = ds.Tables[0].Rows[0];
                //    comsiion_price = double.Parse(dr["com_price"].ToString());
                //}
                //else
                //{
                //    comsiion_price = 0;
                ...
                //double saleman_totl_price = comsiion_price * labour_qty;
                ...
                con.Open();
                cmd.CommandText = "insert into tbl_challan_details_master values('" + txtchallanno.Text.Trim() + "','" + date + "','" + ddlvendor.SelectedItem.Text + "','" + ddlvendor.SelectedValue + "','" + txtarea.Text.Trim() + "','" + qty.Text + "','" + unit.Text + "','" + size.Text + "','" + c_name.Text + "','" + p_code.Text + "','" + rate.Text + "','" + amount.Text + "','" + txttotlamt.Text.Trim() + "','" + txtfraight.Text.Trim() + "','" + txtnetamount.Text.Trim() + "','" + txtinwords.Text.Trim() + "','" + Session["Username"].ToString() + "','" + p_grade.Text + "','','"+ddlvendor.SelectedItem.Text+"')";
                cmd.ExecuteNonQuery();
                ...
                //cmd2.CommandText = " insert into tbl_salesman_ledger_master values('" + Label42.Text + "','" + Label43.Text + "','" + saleman_totl_price + "','','FI','" + date + "','" + txtchallanno.Text.Trim() + "')";
            ...
            if (count > 0)
            {
                ...
                ClientScript.RegisterStartupScript(this.GetType(), "AlertBox", "alert('Created Sucessfully');window.location='new_sample_challan.aspx';", true);
    ...
    {
        SqlDataAdapter adap1 = new SqlDataAdapter("select sum(qty) as qty from tbl_stock_qty_master where size='" + ddlsize1 + "' and c_name='" + ddlcompname1 + "' and p_code='" + ddlpcode1 + "' and p_grade='" + ddlprotype1 + "'", con);
...
"Seventy ","Eighty ", "Ninety "};
    ...
    public void update_stock()
    {
        ...
        string p_code = p_code1;
        string p_grade = p_grade1;
    ...
    protected void GridView1_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        if (e.CommandName == "delete1")
        {
            ...
            if (GridView1.Rows.Count > 0)
            {
                ...
                SqlDataAdapter adap1 = new SqlDataAdapter("select sum(qty) as qty from tbl_stock_qty_master where size='" + size1 + "' and c_name='" + c_name1 + "' and p_code='" + p_code1 + "' and p_grade='" + p_grade1 + "'", con);
                DataSet ds1 = new DataSet();
                adap1.Fill(ds1);
                {
                    DataRow dr1 = ds1.Tables[0].Rows[0];
    ...
    public void bind_saleman()
    {
        adap = new SqlDataAdapter("select * from tbl_salesman_master where dealer_id='" + ddlvendor.SelectedValue + "'", con);
        ds = new DataSet();
        adap.Fill(ds);
        if (ds.Tables[0].Rows.Count != 0)
        {
            ...
            DataRow dr = ds.Tables[0].Rows[0];
            Label42.Text = dr["name"].ToString();
            Label43.Text = dr["id"].ToString();
    ...
    public void add_dealer_ledger()
    {
        ...
        cmd = con.CreateCommand();
        con.Open();
        cmd.CommandText = "insert into tbl_sample_ledger_master values('" + ddlvendor.SelectedItem.Text + "','" + ddlvendor.SelectedValue + "','" + txtnetamount.Text.Trim() + "','','" + date + "','" + txtchallanno.Text.Trim() + "','')";
        cmd.ExecuteNonQuery();

        //dump ledger
        SqlCommand cmd311 = con.CreateCommand();
        cmd311.CommandText = " insert into tbl_dump_debit_master values ('" + ddlvendor.SelectedItem.Text + "','','" + DateTime.ParseExact(txtdate.Text, "MM/dd/yyyy", CultureInfo.InvariantCulture).ToString("MM/dd/yyyy", CultureInfo.InvariantCulture) + "','','SMD','" + txtnetamount.Text.Trim() + "')";

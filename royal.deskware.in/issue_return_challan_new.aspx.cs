...
public partial class issue_return_challan_new : System.Web.UI.Page
{
    ...
    protected void btnsubmit_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            for (j = 0; j < GridView1.Rows.Count; j++)
            {
                ...
                adap = new SqlDataAdapter("select com_price from tbl_salesman_commission_pricing where salesman_id='" + Label43.Text + "' and size='" + size.Text + "' and c_name='" + c_name.Text + "'", con);
                ds = new DataSet();
                adap.Fill(ds);
                ...
                cmd1.CommandText = " insert into tbl_salesman_ledger_master values('" + Label42.Text + "','" + Label43.Text + "','','" + saleman_totl_price + "','RI','" + date + "','" + txtchallanno.Text.Trim() + "')";
            ...
            if (count > 0)
            {
                ...
                ClientScript.RegisterStartupScript(this.GetType(), "AlertBox", "alert('Created Sucessfully');window.location='issue_return_challan_new.aspx';", true);

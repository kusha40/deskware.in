...
public partial class create_product : System.Web.UI.Page
{
    ...
    protected void btnsubmit_Click(object sender, EventArgs e)
    {
        ...
        con.Open();
        cmd.CommandText = " insert into tbl_product_master values ('" + ddlsize.SelectedValue + "','" + ddlcompname.SelectedValue + "','" + ddlprotype.SelectedValue + "','" + txtpcode.Text.Trim() + "','" + ddlunit.SelectedValue + "','"+txtstocklevel.Text.Trim()+"','"+TextBox1.Text.Trim()+"')";
        cmd.ExecuteNonQuery();
        con.Close();

<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="trolla_labour_ledger.aspx.cs" Inherits="trolla_labour_ledger" EnableEventValidation="false" %>
                    ...
                    <div class="padding-md">
                        <div class="panel panel-info">
                            <div class="panel-heading">
                                Daily Trolla Labour Ledger</div>
                                    ...
                                    <div class="col-md-10 table-responsive">
                                        <form>
                                            ...
                                            <div class="form-group ">
					                               Trolla Labour Name
                   <asp:DropDownList ID="ddllabour" runat="server" class="form-control chzn-select">
					...
					<asp:GridView ID="GridView1" runat="server" CssClass="Grid" AutoGenerateColumns="False" DataKeyNames="id" OnRowCommand="GridView1_RowCommand" OnRowDataBound="GridView1_RowDataBound"  >
                            ...
                            <ItemTemplate>
                                <asp:Label ID="Label1" runat="server" Text='<%# Bind("id") %>'></asp:Label>
                                        ...
                                        <%--<asp:BoundField DataField="stock_id" HeaderText="Challan No." />--%>
                                        <asp:BoundField DataField="labour" HeaderText="Trolla Labour" />

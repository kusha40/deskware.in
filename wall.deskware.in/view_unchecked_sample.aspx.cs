...
public partial class view_unchecked_sample : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            cls.gridbind(GridView3, "select * from tbl_sample_entry where dealer_name='" + Request.QueryString["did"].ToString() + "' and date ='" + Request.QueryString["dt"].ToString() + "' and (sts!='ok') and (sts2!='ok')  order by date asc ");
        }

<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/site.master" AutoEventWireup="true" CodeFile="cheque_out.aspx.cs" Inherits="Admin_cheque_out" %>
                   ...
                   <div class="form-group">
                            <div class="row gutter">
                                 <div class="col-md-6">
                                      ...
                                      <asp:RadioButtonList ID="RadioButtonList1" runat="server" class="chkbox1" RepeatColumns="3" RepeatDirection="Horizontal" AutoPostBack="True" OnSelectedIndexChanged="RadioButtonList1_SelectedIndexChanged">
                                           <asp:ListItem Selected="True" Value="A">Admin Expenses</asp:ListItem>

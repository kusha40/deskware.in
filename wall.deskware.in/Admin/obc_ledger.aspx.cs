...
public partial class Admin_obc_ledger : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            h3.Visible = true;
            cls.gridbind(GridView1, "select * from [tbl_bank_ledger_master] where bank='OBC'  order by id asc,date asc ");
    ...
    protected void GridView1_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        ...
        {
            ClientScript.RegisterStartupScript(this.Page.GetType(), "", "window.open('../delete_ledger_entry.aspx?id=" + e.CommandArgument.ToString() + "&typ=obcledger','Graph','height=724px,width=900px,scrollbars=1' );", true);
        }
    }
    double bal1 = 0.00;
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        cls.gridbind(GridView1, "select * from [tbl_bank_ledger_master] where date between '" + from_date + "' and '" + to_date + "' and bank='OBC'  order by date asc ");
        ...
        if (ds.Tables[0].Rows.Count != 0)
        {
            ...
            for (j = 0; j < GridView1.Rows.Count; j++)
            {
                ...
                if (cb.Checked == true)
                {
                    ...
                    con.Open();
                    cmd.CommandText = "Delete tbl_bank_ledger_master    where id='" + id.Text + "' and bank='OBC'";
                    cmd.ExecuteNonQuery();
                    con.Close();
            ...
            if (count > 0)
            {
                ClientScript.RegisterStartupScript(this.GetType(), "AlertBox", "alert('Deleted Sucessfully');window.location='obc_ledger.aspx';", true);
            }
            else
            {

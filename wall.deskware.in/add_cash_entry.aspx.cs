...
public partial class add_cash_entry : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        else
        {
            if (!IsPostBack)
            {
                ...
                {
                    DropDownList1.Items.Insert(0, "Current");
                    DropDownList1.Items.Insert(1, "OBC");
                    DropDownList1.Items.Insert(2, "HDFC");
                }
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        if (Request.QueryString["type"] == "Salesman")
        {
            commnd = " insert into tbl_salesman_ledger_master values('" + DropDownList1.SelectedItem.Text + "','" + DropDownList1.SelectedValue + "','','" + txtamount.Text.Trim() + "','" + txtremarks.Text.Trim() + "','" + date + "','"+cls.rand("")+"')";
            //add  cash out ledger//
        ...
        if (Request.QueryString["type"] == "Company")
        {
         ...
         if (Request.QueryString["type"] == "Driver")
        {
            commnd = " insert into tbl_driver_ledger_master values('" + DropDownList1.SelectedItem.Text + "','" + DropDownList1.SelectedValue + "','','" + txtamount.Text.Trim() + "','" + txtremarks.Text.Trim() + "','" + date + "','" + cls.rand("") + "')";
            //add  cash out ledger//
            commnd1 = " insert into tbl_cash_ledger_master values ('" + DropDownList1.SelectedItem.Text + "','" + DropDownList1.SelectedValue + "','" + txtamount.Text.Trim() + "','','" + date + "','','" + txtremarks.Text.Trim() + "')";
        }
         if (Request.QueryString["type"] == "Daily Labour")
        {
            commnd = " insert into tbl_daily_labour_ledger_master values('Daily Labour','','" + txtamount.Text.Trim() + "','" + date + "','" + cls.rand("") + "','" + txtremarks.Text.Trim() + "')";
            //add  cash out ledger//
            commnd1 = " insert into tbl_cash_ledger_master values ('Daily Labour','','" + txtamount.Text.Trim() + "','','" + date + "','','" + txtremarks.Text.Trim() + "')";
        }
        if (Request.QueryString["type"] == "Trolla Labour")
        {
            commnd = " insert into tbl_trolla_labour_ledger_master values('Trolla Labour','','" + txtamount.Text.Trim() + "','" + date + "','" + cls.rand("") + "','" + txtremarks.Text.Trim() + "')";
            //add  cash out ledger//
            commnd1 = " insert into tbl_cash_ledger_master values ('Trolla Labour','','" + txtamount.Text.Trim() + "','','" + date + "','','" + txtremarks.Text.Trim() + "')";
        }
        if (Request.QueryString["type"] == "Expenses")
        {
            commnd1 = " insert into tbl_cash_ledger_master values ('" + DropDownList1.SelectedItem.Text + "','" + DropDownList1.SelectedValue + "','" + txtamount.Text.Trim() + "','','" + date + "','" + cls.rand("") + "','" + txtremarks.Text.Trim() + "')";
        }
        if (Request.QueryString["type"] == "PermissionExpenses")
        {
        ...
        if (Request.QueryString["type"] == "Bank")
        {
            commnd = " insert into tbl_bank_ledger_master values ('" + DropDownList1.SelectedValue + "','','','" + txtamount.Text.Trim() + "','" + DateTime.ParseExact(txtdate.Text, "MM/dd/yyyy", CultureInfo.InvariantCulture).ToString("MM/dd/yyyy", CultureInfo.InvariantCulture) + "','','" + txtremarks.Text.Trim() + "','" + DropDownList1.SelectedValue + "')";

            commnd1 = " insert into tbl_cash_ledger_master values ('" + DropDownList1.SelectedItem.Text + "','" + System.DateTime.Now.ToString("mmsshhddMMyy") + "','" + txtamount.Text.Trim() + "','','" + date + "','','" + txtremarks.Text.Trim() + "')";
        }
        ...
        if (Request.QueryString["type"] == "Driver")
        {
            ...
            con.Open();
            cmd311.CommandText = " insert into tbl_dump_debit_master values ('" + DropDownList1.SelectedItem.Text + "','" + txtremarks.Text.Trim() + "','" + DateTime.ParseExact(txtdate.Text, "MM/dd/yyyy", CultureInfo.InvariantCulture).ToString("MM/dd/yyyy", CultureInfo.InvariantCulture) + "','','CD','" + txtamount.Text.Trim() + "')";

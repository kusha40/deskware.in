...
public partial class issue_comp_return : System.Web.UI.Page
{
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        dt.Rows.Add(txtqty.Text.Trim(), ddlsize0.SelectedValue, ddlsize.SelectedValue, ddlcompname.SelectedValue, ddlpcode.SelectedValue, txtmrp.Text.Trim(), amount);
        ViewState["challan"] = dt;
        GridView1.DataSource = (DataTable)ViewState["challan"];
        GridView1.DataBind();
         ...
         try
        {
            ...
            for (j = 0; j < GridView1.Rows.Count; j++)
            {
              ...
              SqlCommand  cmd1 = con.CreateCommand();
                ...
                cmd1.CommandText = "insert into tbl_company_ledger_master values('" + c_name.Text.Trim() + "','','" + txttotlamt.Text + "','" + date + "','" + txtchallanno.Text.Trim() + "','Return')";
            ...
            {
                bind_stock();
                ClientScript.RegisterStartupScript(this.GetType(), "AlertBox", "alert('Created Sucessfully');window.location='issue_comp_return.aspx';", true);

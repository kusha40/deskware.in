<%@ Page Language="C#" AutoEventWireup="true" CodeFile="issue_challan_new_wom.aspx.cs" Inherits="issue_challan_new_wom" %>
    ...
    <table cellpadding="0" cellspacing="0" style="border:1px solid black; padding:10px" width="650px">
                    ...
                    <asp:TextBox ID="txtchallanno" runat="server" ></asp:TextBox>
                                             ...
                                             <td>
                                                 ...
                                                 <asp:DropDownList ID="ddlvendor"  runat="server" class="chzn-select" ></asp:DropDownList>
                
					
				                            </td>
                                        </tr>
        <div id="dif" runat="server" visible="false">
                                        <tr>
                                            <td>
					                                Size
                   ...
                   <asp:DropDownList ID="ddlsize" runat="server"  >
				                                ...
				                                <asp:DropDownList ID="ddlprotype" runat="server" Visible="false">
...
<h5 id="h5" runat="server" visible="false">Available Stock: <asp:Label ID="Label3" runat="server" Text="0" Font-Bold="True" ForeColor="Red"></asp:Label></h5>
                    ...
                    <asp:TextBox ID="txttotlamt" runat="server" class="form-control input-sm" AutoPostBack="True" OnTextChanged="txttotlamt_TextChanged">0</asp:TextBox>

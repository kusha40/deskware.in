                    ...
                    <div class="padding-md">
                        <div class="panel panel-info">
                            <div class="panel-heading">
                                Set Dealer Minimum Pricing</div>
		...
		<script type="text/javascript"> $(".chzn-select").chosen(); $(".chzn-select-deselect").chosen({ allow_single_deselect: true }); </script>
                                  ...
                                  <div id="div2" runat="server" >
                                          <div class="form-group col-lg-3 ">
					                             Size
 <asp:DropDownList ID="ddlsize" runat="server" class="form-control" >
                                                    </asp:DropDownList>
...
&nbsp;<asp:TextBox ID="txtdprice" runat="server" class="form-control input-sm"></asp:TextBox>
                                                                  ...
                                                                  <div class="form-group col-lg-2 " id="div1" runat="server" visible="false">
					                          Saleman Pricing
                                ...
                                <br />
                                        ...
                                        <asp:TemplateField HeaderText="Dealer Price">
                                            <ItemTemplate>
                                             ...
                                             <asp:TemplateField HeaderText="Salesman Price" Visible="False">
                                                 <ItemTemplate>
					...
					<asp:GridView ID="GridView1" runat="server" CssClass="Grid" AutoGenerateColumns="False" OnRowDeleting="GridView1_RowDeleting" DataKeyNames="id"  >
                            ...
                            <ItemTemplate>
                                <%--<asp:Label ID="Label1" runat="server" Text='<%# Bind("id") %>'></asp:Label>--%>
                                        ...
                                        <asp:BoundField DataField="dealer_name" HeaderText="Dealer Name" Visible="False" />
                                        ...
                                        <asp:BoundField DataField="s_price" HeaderText="Saleman Price" DataFormatString="{0:n2}" Visible="False" />

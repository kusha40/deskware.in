...
public partial class issue_challan_new_wom : System.Web.UI.Page
{
           ...
           // if (count > 0)
            {
                ...
                ClientScript.RegisterStartupScript(this.GetType(), "AlertBox", "alert('Created Sucessfully');window.location='issue_challan_new_wom.aspx';", true);

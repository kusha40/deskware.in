<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="cash_ledger.aspx.cs" Inherits="cash_ledger" EnableEventValidation="false" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
                    ...
                    <div class="padding-md">&nbsp;<div class="panel panel-info">
                            ...
                            <div class="panel-body">
                                <div class="tab-content">
                                    <asp:DropDownList ID="DropDownList1" runat="server" class="form-control chzn-select" Visible="false" AutoPostBack="True" OnSelectedIndexChanged="DropDownList1_SelectedIndexChanged">
                                        </asp:DropDownList>
    ...
    <script src="js/chosen.jquery.js" type="text/javascript"></script>
		<script type="text/javascript"> $(".chzn-select").chosen(); $(".chzn-select-deselect").chosen({ allow_single_deselect: true }); </script>
                     ...
                     &nbsp;&nbsp;
                                		<asp:Button ID="btnsubmit0" runat="server" Text="Today Cash IN" class="btn btn-success btn-sm " OnClick="btnsubmit0_Click"  />
                     &nbsp;&nbsp;
                                		<asp:Button ID="btnsubmit1" runat="server" Text="Today Cash Out" class="btn btn-success btn-sm " Visible="false" OnClick="btnsubmit1_Click"  />

<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="company_ledger_other.aspx.cs" Inherits="company_ledger_other" EnableEventValidation="false" %>
                            ...
                            <ItemTemplate>
                                <asp:Label ID="Label1" runat="server" Text='<%# Bind("id") %>'></asp:Label>
                                        ...
                                        <asp:TemplateField HeaderText="Challan No.">
                                            ...
                                            <ItemTemplate>
                                               <a href="comp_ledger_edit.aspx?cno=<%# Eval("stock_id") %>" target="_blank" >
                                                <asp:Label ID="Label2" runat="server" Text='<%# Bind("stock_id") %>'></asp:Label>
                                                   </a>
                                            </ItemTemplate>
                                        </asp:TemplateField>

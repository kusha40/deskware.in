...
public partial class Admin_volume_report : System.Web.UI.Page
{
    ...
    //{
    //    string query = "select * from ( select qty, (size+c_name)as size1,[dealer_name]as Name from tbl_challan_details_master )as source Pivot (  SUM(qty) for size1  in( [12x18Allient],[12x18Murano],[12x18Specto],[12x24Arido],[12x24Capsun],[12x24Murano],[12x24Pioneer],[12x24Savitra],[2x2Livanto],[2x2Senso],[2x2Veeta],[2x2Zed],[2x4Veeta],[2x4Zed],[32x32Veeta]))as pvt";
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        if (ddlcom.SelectedValue == "All" && ddldealer.SelectedValue=="All" && ddlsize.SelectedValue=="All" )
        {
            string from_date = DateTime.ParseExact(txtfdate.Text, "MM/dd/yyyy", CultureInfo.InvariantCulture).ToString("MM/dd/yyyy", CultureInfo.InvariantCulture);
            string to_date = DateTime.ParseExact(txttdate.Text, "MM/dd/yyyy", CultureInfo.InvariantCulture).ToString("MM/dd/yyyy", CultureInfo.InvariantCulture);
            cls.gridbind(GridView1, "select * from ( select qty, (size+c_name)as size1,[dealer_name]as Name from tbl_challan_details_master where date between '" + from_date + "' and '" + to_date + "' and type='FI' and status!='Cancel' and dealer_name not in ('Sample','Breakage','Lost','Trolla Breakage') )as source Pivot (  SUM(qty) for size1  in( [12x18Allient],[12x18Murano],[12x18Specto],[12x24Arido],[12x24Capsun],[12x24Murano],[12x24Pioneer],[12x24Savitra],[2x2Livanto],[2x2Senso],[2x2Veeta],[2x2Zed],[2x4Veeta],[2x4Zed],[32x32Veeta]))as pvt");
        }
        if (ddlcom.SelectedValue != "All" && ddldealer.SelectedValue == "All" && ddlsize.SelectedValue != "All")
        {
            string from_date = DateTime.ParseExact(txtfdate.Text, "MM/dd/yyyy", CultureInfo.InvariantCulture).ToString("MM/dd/yyyy", CultureInfo.InvariantCulture);
            string to_date = DateTime.ParseExact(txttdate.Text, "MM/dd/yyyy", CultureInfo.InvariantCulture).ToString("MM/dd/yyyy", CultureInfo.InvariantCulture);
            cls.gridbind(GridView1, "select * from ( select qty, (size+c_name)as size1,[dealer_name]as Name from tbl_challan_details_master where date between '" + from_date + "' and '" + to_date + "' and c_name='" + ddlcom.SelectedValue + "' and size='" + ddlsize.SelectedValue + "' and type='FI' and status!='Cancel' and dealer_name not in ('Sample','Breakage','Lost','Trolla Breakage') )as source Pivot (  SUM(qty) for size1  in( [12x18Allient],[12x18Murano],[12x18Specto],[12x24Arido],[12x24Capsun],[12x24Murano],[12x24Pioneer],[12x24Savitra],[2x2Livanto],[2x2Senso],[2x2Veeta],[2x2Zed],[2x4Veeta],[2x4Zed],[32x32Veeta]))as pvt");
        }
        if (ddlcom.SelectedValue == "All" && ddldealer.SelectedValue != "All" && ddlsize.SelectedValue == "All")
        {
            string from_date = DateTime.ParseExact(txtfdate.Text, "MM/dd/yyyy", CultureInfo.InvariantCulture).ToString("MM/dd/yyyy", CultureInfo.InvariantCulture);

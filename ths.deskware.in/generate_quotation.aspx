<%@ Page Title="" Language="C#" MasterPageFile="~/site.master" AutoEventWireup="true" CodeFile="generate_quotation.aspx.cs" Inherits="generate_quotation" %>
...
Due after testing commissioning & handing over</label>
                     ...
                     <div class="form-group" id="div" runat="server" visible="false">
                            <div class="row gutter">
                               <div class="col-md-2">

<%@ Page Title="" Language="C#" MasterPageFile="~/site.master" AutoEventWireup="true" CodeFile="add_lead.aspx.cs" Inherits="add_lead" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div class="row gutter">
                ...
                <div class="panel-body">
                    ...
                    <div class="form-group">
                            <div class="row gutter">
                                   ...
                                   <asp:TextBox ID="txtmobile" runat="server" class="form-control" placeholder="Mobile No." MaxLength="10" pattern="[0-9]{10}"></asp:TextBox>
                                    </div>
                                <div class="col-md-4">
                      ...
                      <div class="form-group">
                            <div class="row gutter">
                                <div class="col-md-12">
                                   ...
                                   <asp:TextBox ID="txtremarks" runat="server" class="form-control" TextMode="MultiLine" placeholder="Remarks"></asp:TextBox>
                                </div></div></div>
        ...
        <asp:Button ID="Button1" runat="server" Text="Submit" class="btn btn-info" OnClick="Button1_Click" />
             ...
             <asp:Button ID="Button2" runat="server" Text="Reset" class="btn btn-default" CausesValidation="false" OnClick="Button2_Click" />
    </div>
</asp:Content>

<%@ Page Title="" Language="C#" MasterPageFile="~/site.master" AutoEventWireup="true" CodeFile="survey_request.aspx.cs" Inherits="survey_request"EnableEventValidation="false" %>
                        ...
                        <div class="table-responsive">
                         ...
                         <%--    <asp:ImageButton ID="LinkButton51" runat="server"  CausesValidation ="false" 
                                   ...
                                   <%-- <asp:ImageButton ID="ImageButton1" runat="server" CausesValidation ="false" 
                                    ...
                                    <asp:ImageButton ID="ImageButton2" runat="server" CausesValidation ="false" 
                                        CommandArgument='<%# Eval("lead_id")%>' 
                                        CommandName="survey" ImageUrl="~/img/survey.png" ToolTip="view Quotation" Height="30px" OnClientClick="return confirm('Are you sure want to request for survey?')" ></asp:ImageButton>
                                    </div>
                            </ItemTemplate>
                        </asp:TemplateField>

...
public partial class future : System.Web.UI.Page
{
    ...
    protected void GridView1_RowCommand(object sender, GridViewCommandEventArgs e)
    {
      ...
      else  if (e.CommandName == "edit12")
        {
            ...
            cmd.ExecuteNonQuery();
            con.Close();
            ClientScript.RegisterStartupScript(this.GetType(), "AlertBox", "alert('Follow Up Added Sucessfully');window.location='future.aspx';", true);
        }

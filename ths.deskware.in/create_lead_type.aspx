<%@ Page Title="" Language="C#" MasterPageFile="~/site.master" AutoEventWireup="true" CodeFile="create_lead_type.aspx.cs" Inherits="create_lead_type" %>
                ...
                <div class="panel-body">
                            ...
                            <div class="row gutter">
                                <div class="col-md-6">
                                   ...
                                   <asp:TextBox ID="TextBox1" runat="server" class="form-control" placeholder="Lead Type"></asp:TextBox>
                                </div>
                            </div>
                            ...
                            <ItemTemplate>
                                <asp:Label ID="Label1" runat="server" Text='<%# Bind("id") %>'></asp:Label>
                                        ...
                                        <asp:TemplateField HeaderText="Type">
                                            <ItemTemplate>
                                                <asp:Label ID="Label21" runat="server" Text='<%# Bind("Type") %>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>

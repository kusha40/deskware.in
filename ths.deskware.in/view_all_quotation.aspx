<%@ Page Title="" Language="C#" MasterPageFile="~/site.master" AutoEventWireup="true" CodeFile="view_all_quotation.aspx.cs" Inherits="view_all_quotation" EnableEventValidation="false" %>
             ...
             $(".autosuggest1").autocomplete({
                 source: function (request, response) {
                     $.ajax({
                         ...
                         url: "view_all_quotation.aspx/GetAutoCompleteData1",
    ...
    <asp:GridView ID="GridView1" class="table table-striped table-bordered no-margin" runat="server" AutoGenerateColumns="False" AllowPaging="True" OnPageIndexChanging="GridView1_PageIndexChanging" PageSize="15" DataKeyNames="id" OnRowDeleting="GridView1_RowDeleting" OnRowCommand="GridView1_RowCommand"   >
                            ...
                            <ItemTemplate>
                             ...
                             <asp:ImageButton ID="LinkButton51" runat="server"  CausesValidation ="false" 
                                        ...
                                        CommandName="email" ImageUrl="~/img/send.png" ToolTip="Send Email" Height="30px" OnClientClick="return confirm('Do you want to Send Quotation ?')"></asp:ImageButton>
                                    </div>
                            </ItemTemplate>
                        </asp:TemplateField>

<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="daily_labour_ledger.aspx.cs" Inherits="daily_labour_ledger" EnableEventValidation="false"%>
                            ...
                            <ItemTemplate>
                                <asp:Label ID="Label1" runat="server" Text='<%# Bind("id") %>'></asp:Label>
                                     ...
                                     <%--     <asp:TemplateField HeaderText="Challan No.">
                                        ...
                                        <asp:BoundField DataField="labour" HeaderText="Labour Name" />

...
public partial class dealer_cash_return_challan : System.Web.UI.Page
{
    ...
    protected void btnsubmit_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            if (count > 0)
            {
                ...
                ClientScript.RegisterStartupScript(this.GetType(), "AlertBox", "alert('Created Sucessfully');window.location='dealer_cash_return_challan.aspx';", true);
...
"Seventy ","Eighty ", "Ninety "};
    ...
    public void add_dealer_ledger()
    {
        ...
        cmd = con.CreateCommand();
        con.Open();
        cmd.CommandText = "insert into tbl_cash_ledger_master values('Cash','52','" + txtnetamount.Text.Trim() + "','','" + date + "','" + txtchallanno.Text.Trim() + "','" + txtarea.Text.Trim() + "')";
        cmd.ExecuteNonQuery();
        con.Close();
    }

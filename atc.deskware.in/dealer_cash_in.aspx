<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="dealer_cash_in.aspx.cs" Inherits="dealer_cash_in" %>
...
<asp:GridView ID="GridView2" runat="server"  AutoGenerateColumns="False" CssClass="Grid" Width="400px" OnRowCommand="GridView2_RowCommand"  >
                                    <Columns>
                                      <asp:TemplateField HeaderText="Sr No.">
                            <ItemTemplate>
                                <%#Container .DataItemIndex +1 %>
                                ...
                                <asp:Label ID="Label3" runat="server" Text='<%# Bind("id") %>'></asp:Label>
                                        ...
                                        <asp:TemplateField HeaderText="Discount">
                                         ...
                                         <asp:TemplateField HeaderText="Remarks">
                                            ...
                                            <asp:TemplateField ShowHeader="False">
                                                                                <ItemTemplate>
                                                                                    <asp:LinkButton ID="lnkadd1" runat="server" CausesValidation="False" CommandArgument='<%# Eval("id")%>' CommandName="delete1" Text="Remove"></asp:LinkButton>
                                                                                </ItemTemplate>
                                                                            </asp:TemplateField>
                                    </Columns>
                                       <EmptyDataTemplate>

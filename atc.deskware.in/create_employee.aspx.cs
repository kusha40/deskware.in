...
public partial class create_employee : System.Web.UI.Page
{
    ...
    protected void btnsubmit_Click(object sender, EventArgs e)
    {
        ...
        con.Open();
        cmd.CommandText = " insert into tbl_employee_master values ('" + txtname.Text.Trim() + "','" + txtmob.Text.Trim() + "','" + txtaddress.Text.Trim() + "','" + txtsalery.Text.Trim() + "')";
        cmd.ExecuteNonQuery();
        con.Close();
    ...
    public void bind()
    {
        cls.gridbind(GridView1, "Select * from tbl_employee_master order by name asc  ");
    }
    protected void GridView1_RowDeleting(object sender, GridViewDeleteEventArgs e)
    {
        ...
        con.Open();
        SqlCommand cmd = new SqlCommand("delete FROM tbl_employee_master where id='" + Convert.ToInt32(GridView1.DataKeys[e.RowIndex].Value.ToString()) + "'", con);
        cmd.ExecuteNonQuery();
        con.Close();
    ...
    protected void GridView1_RowUpdating(object sender, GridViewUpdateEventArgs e)
    {
        ...
        GridView1.EditIndex = -1;
        con.Open();
        SqlCommand cmd = new SqlCommand("update tbl_employee_master set name='" + TextBox1.Text.Trim() + "',mob_no='" + TextBox2.Text.Trim() + "',address='" + TextBox3.Text.Trim() + "',salery='" + TextBox4.Text.Trim() + "'  where id='" + Convert.ToInt32(GridView1.DataKeys[e.RowIndex].Value.ToString()) + "'", con);
        cmd.ExecuteNonQuery();
        con.Close();

...
<body>
   ...
   <p style="page-break-after:always"/>
        <table cellpadding="4" cellspacing="4"  class="tbl" valign="top"  >
              <tr align="center">
                <td colspan="2"><b>ATC</b><br />Estimate
            ...
            <tr align="right" >
                <td>
                    Total Qty :<asp:Label ID="Label32" runat="server" Font-Bold="True" Text="Label"></asp:Label>
                    &nbsp;</td>
                <td>
                    <asp:Label ID="Label6" runat="server" Font-Bold="true" Text="Total Amount"></asp:Label>
                    &nbsp;&nbsp; :&nbsp;</b><asp:Literal ID="Literal5" runat="server" Text='<%#Eval("totlamount","{0:n2}")%>'></asp:Literal>
                </td>
            </tr>

<%@ Page Language="C#" AutoEventWireup="true" CodeFile="view_stock_challan.aspx.cs" Inherits="view_stock_challan" %>
                            ...
                            <ItemTemplate>
                                <asp:Label ID="Label1" runat="server" Text='<%# Bind("stock_id") %>'></asp:Label>
                                        ...
                                        <asp:TemplateField HeaderText="Company Name">
                                            ...
                                            <ItemTemplate>
                                                 <a href="view_stock_challan2.aspx?id=<%# Eval("stock_id") %>&cname=<%# Eval("c_name") %>" target="_blank" >

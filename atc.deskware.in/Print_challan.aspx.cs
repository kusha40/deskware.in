...
public partial class Print_challan : System.Web.UI.Page
{
    ...
    public void bind()
    {
        ...
        adap.Fill(ds);
        {
            ...
            {
                Label bal1 = GridView1.Rows[i].FindControl("Label31") as Label;
        ...
        if (ds1.Tables[0].Rows.Count != 0)
        {
            ...
            if (Literal10.Text != string.Empty)
            {
                ...
                td1.Visible = td2.Visible = td3.Visible = false;
            }
        }
        else
        {

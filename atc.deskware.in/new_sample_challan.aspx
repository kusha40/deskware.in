<%@ Page Language="C#" AutoEventWireup="true" CodeFile="new_sample_challan.aspx.cs" Inherits="new_sample_challan" %>
...
<asp:ListItem>16x16</asp:ListItem>
                         ...
                         <asp:DropDownList ID="ddlcompname" runat="server"  AutoPostBack="True" OnSelectedIndexChanged="ddlcompname_SelectedIndexChanged">
                                             ...
                                             <td>
                                                 ...
                                                 <asp:DropDownList ID="ddlvendor"  runat="server" class="chzn-select" OnSelectedIndexChanged="ddlvendor_SelectedIndexChanged">
                                                     <asp:ListItem Value="5001">Sample</asp:ListItem>
                                                     <asp:ListItem Value="5002">Breakage</asp:ListItem>
                                                     <asp:ListItem Value="5003">Lost</asp:ListItem>
                                                     <asp:ListItem Value="5004">Trolla Breakage</asp:ListItem>
                                                 </asp:DropDownList>
                   ...
                   <asp:DropDownList ID="ddlpcode" runat="server" class="chzn-select" AutoPostBack="True" OnSelectedIndexChanged="ddlpcode_SelectedIndexChanged">
                                                                                            </asp:DropDownList>
                                		...
                                		<asp:Button ID="Button1" runat="server" Text="Add" class="btn btn-success btn-sm " OnClick="Button1_Click" Height="26px"   />
					
				                                 &nbsp;</td>
                                        </tr>
                                        <tr>
                                            <td colspan="3">
<h5 id="h5" runat="server" visible="true">Available Stock: <asp:Label ID="Label3" runat="server" Text="0" Font-Bold="True" ForeColor="Red"></asp:Label></h5>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td colspan="3">

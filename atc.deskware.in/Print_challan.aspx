<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Print_challan.aspx.cs" Inherits="Print_challan" %>
    ...
    <div>
        ...
        <table cellpadding="4" cellspacing="4" width="300px" class="tbl">
            ...
            <tr align="right" id="td2" runat="server">
                ...
                <td><b>Total Amount&nbsp;&nbsp; &nbsp;:&nbsp;</b><asp:Literal ID="Literal5" runat="server"></asp:Literal>&nbsp;&nbsp;</td>
            </tr>
            ...
            <tr>
                <td colspan="2" id="td3" runat="server"><b>Amount in words : </b><asp:Literal ID="Literal8" runat="server"></asp:Literal></td>
            </tr>
            <tr>

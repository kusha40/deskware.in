<%@ Page Language="C#" AutoEventWireup="true" CodeFile="issue_cash_return_challan_new.aspx.cs" Inherits="issue_cash_return_challan_new" %>
...
<body>
    ...
    <div>
    <table cellpadding="0" cellspacing="0" style="border:1px solid black; padding:10px; background-color: #CCCCCC;">
                                        <tr>
                                            <td colspan="2">Date
                    </td>
                                             <td>Challan No.
...
<asp:ListItem>16x16</asp:ListItem>
                         ...
                         <asp:DropDownList ID="ddlcompname" runat="server"  AutoPostBack="True" OnSelectedIndexChanged="ddlcompname_SelectedIndexChanged">
                                             ...
                                             <td>
                                                 ...
                                                 <asp:DropDownList ID="ddlvendor"  runat="server" class="chzn-select" OnSelectedIndexChanged="ddlvendor_SelectedIndexChanged" Width="100px"></asp:DropDownList>
...
<h5 id="h5" runat="server" visible="true">Available Stock: <asp:Label ID="Label3" runat="server" Text="0" Font-Bold="True" ForeColor="Red"></asp:Label></h5>
                    ...
                    <asp:TextBox ID="txttotlamt" runat="server" class="form-control input-sm" ReadOnly="True">0</asp:TextBox>
                                        ...
                                        <tr id="Div15" runat="server" visible="false">
                                            <td colspan="2" >
					                             &nbsp;</td>
                                             <td>
					                             Freight&nbsp;&nbsp;</td>
                  ...
                  <asp:DropDownList ID="ddldrivername" class="form-control " runat="server"  ></asp:DropDownList>
                    ...
                    <asp:TextBox ID="txtvname" runat="server" class="form-control input-sm"  ReadOnly="True"></asp:TextBox>
                                            ...
                                            <div class="form-group col-lg-5 " id="darea" runat="server" visible="false">
					                                Area
                    <asp:TextBox ID="txtarea1" runat="server" class="form-control input-sm"  ReadOnly="True"></asp:TextBox>

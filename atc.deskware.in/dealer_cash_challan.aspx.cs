...
public partial class dealer_cash_challan : System.Web.UI.Page
{
    ...
    protected void btnsubmit_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            if (count > 0)
            {
                ...
                ClientScript.RegisterStartupScript(this.GetType(), "AlertBox", "alert('Created Sucessfully');window.location='dealer_cash_challan.aspx';", true);
...
"Seventy ","Eighty ", "Ninety "};
    ...
    public void add_dealer_ledger()
    {
        ...
        cmd = con.CreateCommand();
        con.Open();
        cmd.CommandText = "insert into tbl_cash_ledger_master values('Cash','53','','" + txtnetamount.Text.Trim() + "','" + date + "','" + txtchallanno.Text.Trim() + "','" + txtarea.Text.Trim() + "')";
        cmd.ExecuteNonQuery();
        con.Close();
    }
    ...
    public void add_dealer_ledger2()
    {
        string date = DateTime.ParseExact(txtdate.Text.Trim(), "MM/dd/yyyy", CultureInfo.InvariantCulture).ToString("MM/dd/yyyy", CultureInfo.InvariantCulture);
        cmd = con.CreateCommand();
        con.Open();

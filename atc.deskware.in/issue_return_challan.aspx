<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="issue_return_challan.aspx.cs" Inherits="issue_return_challan" %>
                    ...
                    <div class="padding-md">
                        <div class="panel panel-info">
                            <div class="panel-heading">
                                Issue Return Challan</div>
                            <div class="panel-body">
                                <div class="tab-content">
                                    <div class="col-lg-10 table-responsive">
                                        <form>
                                                 <iframe id="myIframe" src="issue_return_challan_new.aspx" height="700px" width="635px"></iframe>
                      <div id="div51" runat="server" visible="false">
...
<h5>Available Stock: <asp:Label ID="Label3" runat="server" Text="0" Font-Bold="True" ForeColor="Red"></asp:Label></h5>
                    ...
                    <asp:TextBox ID="txttotlamt" runat="server" class="form-control input-sm" ReadOnly="True">0</asp:TextBox>
                                                                     ...
                                                                     <div class="form-group col-lg-5 " id="fregit" runat="server" visible="false">
					                             Freight

...
public partial class Admin_cheque_out : System.Web.UI.Page
{
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        if (ddltype.SelectedValue == "AGW")
        {
            ...
            if (ddlbank.SelectedValue == "HDFC" || ddlbank.SelectedValue == "OBC" || ddlbank.SelectedValue == "Current")
            {
                //debit//
        ...
        if (ddltype.SelectedValue == "Admin Cash")
        {
            ...
            if (RadioButtonList1.SelectedValue == "A")
            {
                ...
                cmd311.CommandText = " insert into tbl_bank_ledger_master values ('" + ddltype.SelectedValue + "','','" + txtamount.Text.Trim() + "','','" + DateTime.ParseExact(txtdate.Text, "MM/dd/yyyy", CultureInfo.InvariantCulture).ToString("MM/dd/yyyy", CultureInfo.InvariantCulture) + "','','" + txtreamrks.Text.Trim() + "','" + ddlbank.SelectedValue + "')";

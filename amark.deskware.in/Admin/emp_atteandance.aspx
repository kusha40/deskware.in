<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/site.master" AutoEventWireup="true" CodeFile="emp_atteandance.aspx.cs" Inherits="Admin_emp_atteandance" %>
            ...
            <div class="panel">
                ...
                <div class="panel-body">
                        ...
                        <div class="form-group">
                            <div class="row gutter">
                                   <a href="emp_attendance2.aspx" style="color:red">Generate Monthly Salary </a>
                                            <br />
                                            <br />
                                 <div class="col-md-3">

<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="salesman_ledger.aspx.cs" Inherits="salesman_ledger" EnableEventValidation="false" %>
                ...
                <div id="Div1" class="col-sx-4 table-responsive">
                    ...
                    <%--DataKeyNames="id"--%>
                            ...
                            <asp:TextBox ID="TextBox3" runat="server" placeholder="Admin Password" TextMode="Password"></asp:TextBox>
					                    <br />
					<asp:GridView ID="GridView1" runat="server" CssClass="Grid" AutoGenerateColumns="False"  OnRowCommand="GridView1_RowCommand" OnRowDataBound="GridView1_RowDataBound"  >
                                    <Columns>
                            ...
                            <ItemTemplate>
                                <asp:Label ID="Label1" runat="server" Text='<%# Bind("challan_no") %>'></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
                                        ...
                                        <asp:BoundField DataField="salesman" HeaderText="Driver Name" />
                                        ...
                                        <asp:BoundField DataField="remarks" HeaderText="Remarks" />
                                          <asp:TemplateField HeaderText="Challan No.">
                                            ...
                                            <ItemTemplate>
                                                   <a href="print_challan_2.aspx?id=<%# Eval("challan_no") %>" target="_blank" >
                                                <asp:Label ID="Label21" runat="server" Text='<%# Bind("challan_no") %>'></asp:Label>
                                                       </a>
                                            </ItemTemplate>
                                        </asp:TemplateField>

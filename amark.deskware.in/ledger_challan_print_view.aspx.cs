...
public partial class ledger_challan_print_view : System.Web.UI.Page
{
    ...
    public void bind()
    {
        ...
        //SqlDataAdapter adap = new SqlDataAdapter("select * from tbl_challan_details_master where challan_no='" + Request.QueryString["id"].ToString() + "' and dealer_name='" + Request.QueryString["val"].ToString() + "' and dealer_id='" + Request.QueryString["val1"].ToString() + "'and netamount='" + Request.QueryString["val2"].ToString() + "'", con);
        ...
        if (ds.Tables[0].Rows.Count != 0)
        {
           ...
           // cls.gridbind(GridView1, "Select * from tbl_challan_details_master where challan_no='" + Request.QueryString["id"].ToString() + "' and dealer_name='" + Request.QueryString["val"].ToString() + "' and dealer_id='" + Request.QueryString["val1"].ToString() + "'and netamount='" + Request.QueryString["val2"].ToString() + "'");
        ...
        {
            ClientScript.RegisterStartupScript(this.GetType(), "AlertBox", "alert('Challan Preview Not Available');", true);
        }
    }
}
<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="fresh_order_generation.aspx.cs" Inherits="fresh_order_generation"MaintainScrollPositionOnPostback="true" %>
...
<asp:TextBox ID="txtremarks" runat="server" class="form-control input-sm" TextMode="MultiLine"></asp:TextBox>
                         ...
                         <PagerSettings Position="TopAndBottom" />
                    		...
                    		<asp:Button ID="btnsubmit" runat="server" Text=" + Qty Submit" class="btn btn-success btn-sm " OnClick="btnsubmit_Click"  />
					
				                                &nbsp;<asp:Button ID="btnsubmit0" runat="server" Text=" - Qty Submit" class="btn btn-success btn-sm " OnClick="btnsubmit0_Click"   />
					
				                                &nbsp;<asp:Button ID="btnview" runat="server" Text="Pending Order" class="btn btn-sm btn-danger" OnClick="btnview_Click"  />

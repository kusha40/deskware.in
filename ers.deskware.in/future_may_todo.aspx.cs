...
public partial class future_may_todo : System.Web.UI.Page
{
    ...
    {
        cls.gridbind(GridView1, "select top 150 * from tbl_todo where created_by='" + Session["Username"].ToString() + "' and CAST(date AS DATE)='" + System.DateTime.Now.ToString("MM/dd/yyyy") + "' and todo_type='FMTD' order by date desc");
    }
    protected void btnsubmit_Click(object sender, EventArgs e)
    {
        ...
        cmd.ExecuteNonQuery();
        conn.Close();
        ClientScript.RegisterStartupScript(this.GetType(), "AlertBox", "alert('Submitted Sucessfully');window.location='future_may_todo.aspx';", true);
    }

<%@ Page Title="" Language="C#" MasterPageFile="~/site.master" AutoEventWireup="true" CodeFile="complaint_report.aspx.cs" Inherits="complaint_report" EnableEventValidation="false" %>
                        ...
                        <div class="table-responsive col-lg-12">
                            ...
                            <ItemTemplate>
                                <asp:Label ID="Label1" runat="server" Text='<%# Bind("id") %>'></asp:Label>
                                        ...
                                        <asp:CommandField ShowDeleteButton="True" DeleteText="Take Action" >

...
public partial class future_have_todo : System.Web.UI.Page
{
    ...
    {
        cls.gridbind(GridView1, "select top 150 * from tbl_todo where created_by='" + Session["Username"].ToString() + "' and CAST(date AS DATE)='" + System.DateTime.Now.ToString("MM/dd/yyyy") + "' and todo_type='FHTD' order by date desc");
    }

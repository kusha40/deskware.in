            ...
            <div class="login-body">
                 <div class="form-group">
                    <label for="emailId">User ID</label>
                     <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ErrorMessage=" * Enter User ID" ForeColor="Red" ControlToValidate="txtuserid"></asp:RequiredFieldValidator>
                ...
                <div class="form-group">
                    <label for="emailId">Email ID</label>
                       <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage=" * Enter Email ID" ForeColor="Red" ControlToValidate="txtemail"></asp:RequiredFieldValidator>
                    <asp:RegularExpressionValidator ID="RegularExpressionValidator5" runat="server"  ErrorMessage="Invaild Email ID" ControlToValidate="txtemail" ForeColor="Red" ValidationExpression="\w+([-+.']\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*"></asp:RegularExpressionValidator>

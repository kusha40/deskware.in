<%@ Page Title="" Language="C#" MasterPageFile="~/site.master" AutoEventWireup="true" CodeFile="future_have_todo_approval.aspx.cs" Inherits="future_have_todo_approval" EnableEventValidation="false" %>
		...
		<script type="text/javascript"> $(".chzn-select").chosen(); $(".chzn-select-deselect").chosen({ allow_single_deselect: true }); </script>
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="panel panel-blue"><div class="panel-heading">
                      <h4>Future Have To do Approval</h4>
                                              </div>
                            ...
                            <ItemTemplate>
                                <asp:Label ID="Label1" runat="server" Text='<%# Bind("id") %>'></asp:Label>
                                        ...
                                        <asp:TemplateField HeaderText="Reply">
                                            <ItemTemplate>
<asp:Label ID="Label11" runat="server" Text='<%# Bind("reply") %>'></asp:Label>   
                                            </ItemTemplate>
                                        </asp:TemplateField>

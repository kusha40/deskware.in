<%@ Page Title="" Language="C#" MasterPageFile="~/site.master" AutoEventWireup="true" CodeFile="EditReporsMaster.aspx.cs" Inherits="EditReporsMaster" MaintainScrollPositionOnPostback="true" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div runat="server" id="div2">
        ...
        <table cellpadding="5" cellspacing="5">
            <tr>
                <td class="listtitle" colspan="2">School  Details</td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td class="list">
                    ...
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" 
                        ControlToValidate="TextBox24" Display="Dynamic" ForeColor="Red" ErrorMessage="Select School" ValidationGroup="a">*</asp:RequiredFieldValidator>
    ...
    <div runat="server" id="div1" visible="false">
        ...
        <table>
            <tr>
                <td colspan="5">
                    &nbsp;DATE OF EXAMINATION <asp:TextBox ID="TextBox30" runat="server" class="date"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td colspan="2">
                    <h3>School Name :
                        <asp:Literal ID="ltrSchool" runat="server"></asp:Literal></h3>
                </td>
                <td colspan="2">
                  <h3>Session :
                        <asp:Literal ID="ltrsession" runat="server"></asp:Literal></h3></td>
                <td>
                    <h3>Classs :
                        <asp:Literal ID="ltrClass" runat="server"></asp:Literal></h3>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td>
                    <asp:TextBox ID="TextBox20" runat="server" CssClass="date" AutoPostBack="True" OnTextChanged="TextBox20_TextChanged"></asp:TextBox>
        ...
        <table>
            ...
            <tr>
                <td>DEVIATION UPTO +/-10 % IS CONSIDERED AS NORMAL
                </td>
            </tr>
        </table>
        <br />
            ...
            <tr>
                <td>
                    <asp:CheckBoxList ID="CheckBoxList1" RepeatColumns="4" runat="server">
                        ...
                        <asp:ListItem>GOOD ORAL HYGIENE</asp:ListItem>
            ...
            <tr>
                <td>
                    <asp:CheckBoxList ID="CheckBoxList2" RepeatColumns="4" runat="server">
                        <asp:ListItem>BCG SEEN</asp:ListItem>
                        <asp:ListItem>BCG NOT SEEN</asp:ListItem>
                        <asp:ListItem>HYGIENE GOOD</asp:ListItem>
            ...
            <tr>
                <td class="auto-style2">
                    <asp:CheckBoxList ID="CheckBoxList5" RepeatColumns="4" runat="server">
                        ...
                        <asp:ListItem>CHILD IS NORMAL AND HEALTHY</asp:ListItem>

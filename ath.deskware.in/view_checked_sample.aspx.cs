...
public partial class view_checked_sample : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            cls.gridbind(GridView2, "select * from tbl_sample_entry where dealer_name='" + Request.QueryString["did"].ToString() + "' and date ='" + Request.QueryString["dt"].ToString() + "' and (sts='ok') and (sts2='ok' or sentqty='1')  order by date asc ");
        }

<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="all_salesman_bal_sheet.aspx.cs" Inherits="all_salesman_bal_sheet" EnableEventValidation="false" %>
                                ...
                                <asp:Label ID="Label1" runat="server" Text='<%# Bind("id") %>'></asp:Label>
                                   ...
                                   <%--     <asp:TemplateField HeaderText="Challan No.">
                                        ...
                                        <asp:TemplateField HeaderText="Dealer Name">
                                                                                       <ItemTemplate>
                                                                                           <a href="view_dealer_ledger_pop_up.aspx?id=<%# Eval("salesman_id") %>" target="_blank" >
                                                <asp:Label ID="Label1" runat="server" Text='<%# Bind("salesman") %>'></asp:Label>
                                                       </a>

...
public partial class Admin_view_cash_dump : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            //cls.gridbind(GridView1, "select * from tbl_dump_debit_master where type='CD' and date='" + Request.QueryString["dt"].ToString() + "'  order by date asc ");
            if (Request.QueryString["cp"].ToString() == "AM")
            {
                ...
                SqlCommand cmd = new SqlCommand("select * from tbl_dump_debit_master where type='CD' and date='" + Request.QueryString["dt"].ToString() + "'  order by date asc", con);

<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/site.master" AutoEventWireup="true" CodeFile="cash_dump.aspx.cs" Inherits="Admin_cash_dump" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <script src="js/chosen.jquery.js" type="text/javascript"></script>
		<script type="text/javascript"> $(".chzn-select").chosen(); $(".chzn-select-deselect").chosen({ allow_single_deselect: true }); </script>
					...
					<asp:GridView ID="GridView1" runat="server" class="table table-striped table-bordered no-margin" AutoGenerateColumns="False" OnRowCommand="GridView1_RowCommand"   >
                                    <Columns>
                            ...
                            <ItemTemplate>
                              <%--  <asp:Label ID="Label1" runat="server" Text='<%# Bind("id") %>'></asp:Label>--%>
                                      ...
                                      <asp:TemplateField HeaderText="Date">
                                        ...
                                        CommandArgument='<%# Eval("date", "{0:MM/dd/yyyy}") %>' 
                                        CommandName="del"><%# Eval("date", "{0:dd-MMM-yyyy}") %></asp:LinkButton>
                                     <%--                <a href="view_cash_dump.aspx?dt=<%# Eval("date", "{0:MM/dd/yyyy}") %>" target="_blank" style="color:red"><%# Eval("date", "{0:dd-MMM-yyyy}") %></a>--%>

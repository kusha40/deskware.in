<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/site.master" AutoEventWireup="true" CodeFile="dealer_dump.aspx.cs" Inherits="Admin_dealer_dump" %>
					...
					<asp:GridView ID="GridView1" runat="server" class="table table-striped table-bordered no-margin" AutoGenerateColumns="False" OnRowCommand="GridView1_RowCommand"    >
                            ...
                            <ItemTemplate>
                                <asp:Label ID="Label1" runat="server" Text='<%# Bind("id") %>'></asp:Label>
                                 ...
                                 <%--                   <a href="view_dealer_dump.aspx?dt=<%# Eval("date", "{0:MM/dd/yyyy}") %>" target="_blank" style="color:red"><%# Eval("date", "{0:dd-MMM-yyyy}") %></a>--%>

...
public partial class Admin_company_dump : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
           // cls.gridbind(GridView1, "select * from tbl_dump_debit_master where type='CMD'  order by date asc ");
            if (DropDownList1.SelectedValue == "AM")
            {
                ...
                SqlCommand cmd = new SqlCommand("select * from tbl_dump_debit_master where type='CMD'  order by date asc", con);

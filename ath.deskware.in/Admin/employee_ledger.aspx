<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/site.master" AutoEventWireup="true" CodeFile="employee_ledger.aspx.cs" Inherits="Admin_employee_ledger" EnableEventValidation="false" %>
    ...
    <div class="row gutter">
		...
		<script type="text/javascript"> $(".chzn-select").chosen(); $(".chzn-select-deselect").chosen({ allow_single_deselect: true }); </script>
            ...
            <asp:Button ID="Button1" runat="server" Text="View" class="btn btn-info" OnClick="Button1_Click" />
             ...
             <asp:Button ID="Button3" runat="server" Text="View Employee" class="btn btn-info" OnClick="Button3_Click" />
            <br />
            <br />
        </div>
       </div>
                            ...
                            <ItemTemplate>
                                <asp:Label ID="Label1" runat="server" Text='<%# Bind("id") %>'></asp:Label>
                                        ...
                                        <asp:TemplateField HeaderText="Date">
                                            <ItemTemplate>
                                                <a style="color:blue" href="view_employee_ledger.aspx?date=<%# Eval("date", "{0:MM}") %>&id=<%# Eval("dealer_id") %>" target="_blank"><%# Eval("date", "{0:dd-MMM-yyyy}") %></a>

...
public partial class Admin_view_dealer_dump : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            //cls.gridbind(GridView1, "select * from tbl_dump_debit_master where type='DD' and date='"+Request.QueryString["dt"].ToString()+"'  order by date asc ");
            if (Request.QueryString["cp"].ToString() == "AM")
            {
                ...
                SqlCommand cmd = new SqlCommand("select * from tbl_dump_debit_master where type='DD' and date='"+Request.QueryString["dt"].ToString()+"'  order by date asc", con);
            ...
            if (Request.QueryString["cp"].ToString() == "AV")
            {
            ...
            if (Request.QueryString["cp"].ToString() == "RO")
            {
            ...
            if (Request.QueryString["cp"].ToString() == "WA")
            {
            ...
            if (Request.QueryString["cp"].ToString() == "ATH")
            {
            ...
            if (Request.QueryString["cp"].ToString() == "TH")
            {

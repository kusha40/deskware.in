<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="pivotvolumewise.aspx.cs" Inherits="pivotvolumewise" EnableEventValidation="false" %>
					...
					<asp:GridView ID="GridView1" runat="server" class="table table-striped table-bordered no-margin" AutoGenerateColumns="False" ShowFooter="True" OnRowDataBound="GridView1_RowDataBound"  >
                            ...
                            <ItemTemplate>
                                ...
                                <br />
                                        ...
                                        <asp:TemplateField HeaderText="12x18exclusive">
                                             
                                                   <ItemTemplate>
                                                       <asp:Label ID="lbl1001" runat="server" Text='<%# Bind("12x18exclusive", "{0:n2}") %>'></asp:Label>
                                                         
                                                   </ItemTemplate>
                                                       <FooterTemplate>
                                              <asp:Label ID="lbl2001" runat="server" Text="Label"></asp:Label>
                                          </FooterTemplate>
                                        </asp:TemplateField>
                                        ...
                                        <asp:TemplateField HeaderText="12x18Specto">
                                         ...
                                         <asp:TemplateField HeaderText="12x18TILEX">
                                          ...
                                          <asp:TemplateField HeaderText="12x24Allient">
                                       
                                            <ItemTemplate>
                                                <asp:Label ID="lbl1002" runat="server" Text='<%# Bind("12x24Allient", "{0:n2}") %>'></asp:Label>
                                            </ItemTemplate>
                                             <FooterTemplate>
                                              <asp:Label ID="lbl2002" runat="server" Text="Label"></asp:Label>
                                          </FooterTemplate>
                                        </asp:TemplateField>
                                        ...
                                        <asp:TemplateField HeaderText="12x24Capsun">
                                            ...
                                            <ItemTemplate>
                                             ...
                                             <asp:TemplateField HeaderText="12x24exclusive">
                                       
                                            <ItemTemplate>
                                                <asp:Label ID="lbl1003" runat="server" Text='<%# Bind("12x24exclusive", "{0:n2}") %>'></asp:Label>
                                            </ItemTemplate>
                                                 <FooterTemplate>
                                              <asp:Label ID="lbl2003" runat="server" Text="Label"></asp:Label>
                                          </FooterTemplate>
                                        </asp:TemplateField>
                                        ...
                                        <asp:TemplateField HeaderText="2x2exclusive">
                                      
                                            <ItemTemplate>
                                                <asp:Label ID="lbl1004" runat="server" Text='<%# Bind("2x2exclusive", "{0:n2}") %>'></asp:Label>
                                            </ItemTemplate>
                                                 <FooterTemplate>
                                              <asp:Label ID="lbl2004" runat="server" Text="Label"></asp:Label>
                                          </FooterTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="2x2Livanto">
                                         ...
                                         <asp:TemplateField HeaderText="2x2PREM">
                                         
                                            <ItemTemplate>
                                                <asp:Label ID="lbl1005" runat="server" Text='<%# Bind("2x2PREM", "{0:n2}") %>'></asp:Label>
                                            </ItemTemplate>
                                                 <FooterTemplate>
                                              <asp:Label ID="lbl2005" runat="server" Text="Label"></asp:Label>
                                          </FooterTemplate>
                                        </asp:TemplateField>
                                        ...
                                        <asp:TemplateField HeaderText="2x4exclusive">
                                       
                                            <ItemTemplate>
                                                <asp:Label ID="lbl1006" runat="server" Text='<%# Bind("2x4exclusive", "{0:n2}") %>'></asp:Label>
                                            </ItemTemplate>
                                                 <FooterTemplate>
                                              <asp:Label ID="lbl2006" runat="server" Text="Label"></asp:Label>
                                          </FooterTemplate>
                                        </asp:TemplateField>
                                         <asp:TemplateField HeaderText="2x4HIGHGLOSSY">
                                       
                                            <ItemTemplate>
                                                <asp:Label ID="lbl1007" runat="server" Text='<%# Bind("2x4HIGHGLOSSY", "{0:n2}") %>'></asp:Label>
                                            </ItemTemplate>
                                                 <FooterTemplate>
                                              <asp:Label ID="lbl2007" runat="server" Text="Label"></asp:Label>
                                          </FooterTemplate>
                                        </asp:TemplateField>
                                           <asp:TemplateField HeaderText="2x4PREM">
                                       
                                            <ItemTemplate>
                                                <asp:Label ID="lbl1008" runat="server" Text='<%# Bind("2x4PREM", "{0:n2}") %>'></asp:Label>
                                            </ItemTemplate>
                                                 <FooterTemplate>
                                              <asp:Label ID="lbl2008" runat="server" Text="Label"></asp:Label>
                                          </FooterTemplate>
                                        </asp:TemplateField>
                                     ...
                                     <asp:TemplateField HeaderText="32x32PREM">
                                       
                                            <ItemTemplate>
                                                <asp:Label ID="lbl1009" runat="server" Text='<%# Bind("32x32PREM", "{0:n2}") %>'></asp:Label>
                                            </ItemTemplate>
                                                 <FooterTemplate>
                                              <asp:Label ID="lbl2009" runat="server" Text="Label"></asp:Label>
                                          </FooterTemplate>
                                        </asp:TemplateField>

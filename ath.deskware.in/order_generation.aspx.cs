...
public partial class order_generation : System.Web.UI.Page
{
    ...
    protected void GridView1_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            Label size = e.Row.FindControl("Label5") as Label;
            Label c_name = e.Row.FindControl("Label6") as Label;

            SqlDataAdapter adap = new SqlDataAdapter("select top 1 qty from tbl_stock_qty_master where p_code='" + p_code.Text + "' and size='" + size.Text + "' and c_name='" + c_name .Text+ "'  order by id desc ", con);

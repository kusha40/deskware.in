...
public partial class issue_cash_challan_new : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
           // cls.bind_ddl(ddlvendor, "Select name,id from tbl_dealer_Master order by name asc", "name", "id");
            ...
            ddlvendor.Items.Add(new ListItem("Cash", "151"));
    ...
    protected void btnsubmit_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            if (count > 0)
            {
                ...
                ClientScript.RegisterStartupScript(this.GetType(), "AlertBox", "alert('Created Sucessfully');window.location='issue_cash_challan_new.aspx';", true);

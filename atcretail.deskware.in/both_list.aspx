<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="both_list.aspx.cs" Inherits="both_list" %>
                            ...
                            <ItemTemplate>
                                <asp:Label ID="Label1" runat="server" Text='<%# Bind("id") %>'></asp:Label>
                                        ...
                                        <asp:TemplateField HeaderText="Challan No.">
                                            ...
                                            <ItemTemplate>
                                                   <a href="chk_challan.aspx?cno=<%# Eval("challan_no") %>&dname=<%# Eval("dealer_name") %>&did=<%# Eval("dealer_id") %>" target="_blank" >

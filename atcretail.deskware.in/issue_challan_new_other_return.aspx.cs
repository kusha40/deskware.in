...
public partial class issue_challan_new_other_return : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            cls.bind_ddl(ddlcompname, "Select cname from tbl_other_item_master order by cname asc", "cname", "cname");
    ...
    {
        SqlDataAdapter adap1 = new SqlDataAdapter("select sum(qty) as qty from tbl_stock_qty_master_other where  c_name='" + ddlcompname1 + "' and p_code='" + ddlpcode1 + "'", con);
        ...
        adap1.Fill(ds1);
        {
            ...
            cmd5.CommandText = " update tbl_stock_qty_master_other set  qty='" + Label3.Text + "' where    c_name='" + ddlcompname1 + "' and p_code='" + ddlpcode1 + "' ";
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        dt.Rows.Add(txtqty.Text.Trim(), ddlsize0.SelectedValue, ddlsize.SelectedValue, ddlcompname.SelectedValue, ddlpcode.SelectedValue, ddlprotype.SelectedValue, txtmrp.Text.Trim(), '0');
        ViewState["challan"] = dt;
        GridView1.DataSource = (DataTable)ViewState["challan"];
        GridView1.DataBind();

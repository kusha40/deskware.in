<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="stock_show_other.aspx.cs" Inherits="stock_show_other" %>
                                    ...
                                    <div class="col-md-10 table-responsive">
                                        <form>
                                            ...
                                            <div class="form-group col-lg-3 ">
					                             Size
 <asp:DropDownList ID="ddlsize" runat="server" class="form-control" Visible="False" >
                                                    </asp:DropDownList>

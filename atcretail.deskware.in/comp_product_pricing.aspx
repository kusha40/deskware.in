<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="comp_product_pricing.aspx.cs" Inherits="comp_product_pricing" %>
                    ...
                    <div class="padding-md">
                        <div class="panel panel-info">
                            <div class="panel-heading">
                                Create Company Product Pricing</div>
                                        ...
                                        <asp:TemplateField HeaderText="Size">
                                         ...
                                         <asp:TemplateField HeaderText="Company Name">
                                           ...
                                           <asp:TemplateField HeaderText="Price">
                                            <ItemTemplate>
                                                <asp:Label ID="Label22" runat="server" Text='<%# Bind("price","{0:n2}") %>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>

...
public partial class issue_cash_return_challan : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
         ...
         //   cls.bind_ddl(ddlcompname, "Select name from tbl_company_master order by name asc", "name", "name");
            ...
            cls.bind_ddl(ddlsize, "Select size from tbl_product_master order by size asc", "size", "size");
    ...
    string ddlsize1, ddlcompname1, ddlpcode1, ddlprotype1, qty2, unit2 = "";
    ...
    protected void btnsubmit_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            if (count > 0)
            {
                ...
                ClientScript.RegisterStartupScript(this.GetType(), "AlertBox", "alert('Created Sucessfully');window.location='issue_dealer_return_challan.aspx';", true);
    ...
    {
        SqlDataAdapter adap1 = new SqlDataAdapter("select  qty from tbl_stock_qty_master where size='" + ddlsize1 + "' and c_name='" + ddlcompname1 + "' and p_code='" + ddlpcode1 + "'", con);
        ...
        Label8.Text = Convert.ToDouble(double.Parse(Label8.Text) + double.Parse(qty2)).ToString();
        SqlCommand cmd3 = con.CreateCommand();
        con.Open();
        cmd3.CommandText = " select count(id) from tbl_stock_qty_master where  size= '" + ddlsize1 + "' and c_name='" + ddlcompname1 + "' and p_code='" + ddlpcode1 + "' and p_grade='" + ddlprotype1 + "'";
        int a = int.Parse(cmd3.ExecuteScalar().ToString());
        if (a == 0)
        {
            SqlCommand cmd4 = con.CreateCommand();
            cmd4.CommandText = "insert into tbl_stock_qty_master values ('" + ddlsize1 + "','" + ddlcompname1 + "','" + ddlpcode1 + "','" + Label8.Text + "','" + ddlprotype1 + "','" + unit2 + "')";
            cmd4.ExecuteNonQuery();
        }
        else
        {
            SqlCommand cmd5 = con.CreateCommand();
            cmd5.CommandText = "update tbl_stock_qty_master  set qty= '" + Label8.Text + "' where  size= '" + ddlsize1 + "' and c_name='" + ddlcompname1 + "' and p_code='" + ddlpcode1 + "' and p_grade='" + ddlprotype1 + "'";
...
"Seventy ","Eighty ", "Ninety "};
    ...
    public void add_cash_ledger()
    {
        ...
        cmd = con.CreateCommand();
        con.Open();
        cmd.CommandText = "insert into tbl_cash_ledger_master values('" + ddlvendor.SelectedItem.Text + "','" + ddlvendor.SelectedValue + "','" + txtpaid.Text.Trim() + "','','" + date + "','" + txtchallanno.Text.Trim() + "','Cash Return')";
        cmd.ExecuteNonQuery();
        con.Close();
        ...
        //cmd = con.CreateCommand();
        //con.Open();
        //cmd.CommandText = "insert into tbl_dealer_ledger_master values('" + ddlvendor.SelectedItem.Text + "','" + ddlvendor.SelectedValue + "','','" + txtpaid.Text.Trim() + "','" + date + "','" + txtchallanno.Text + "','')";
        //cmd.ExecuteNonQuery();
        //con.Close();
    }

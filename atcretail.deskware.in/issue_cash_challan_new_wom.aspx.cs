...
public partial class issue_cash_challan_new_wom : System.Web.UI.Page
{
           ...
           // if (count > 0)
            {
                ...
                ClientScript.RegisterStartupScript(this.GetType(), "AlertBox", "alert('Created Sucessfully');window.location='issue_cash_challan_new_wom.aspx';", true);
...
"Seventy ","Eighty ", "Ninety "};
    ...
    protected void txttotlamt_TextChanged(object sender, EventArgs e)
    {
        double nettotl = (double.Parse(txttotlamt.Text.Trim()) + (double.Parse(txtfraight.Text.Trim())) + (double.Parse(txtlabour.Text.Trim())));
